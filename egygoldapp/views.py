...
def ScrapDollarPricetoday(url):
    ...
    return list,list1,date,span1,span2
...
def home(request):
    ...
    try:
        ...
        context = {
        'title': 'الذهب اليوم - اسعار الذهب لحظة بلحظة',
        'posts':  posts,
        'posts1': posts1,
        'posts2': posts2,
        'posts3': posts3,
...
def article_saudi(request):
    ...
    link = "/static/images/sudia-1.png"
    try:
...
def article_kuwait(request):
    ...
    now1 = x.strftime("%d-%m-%Y")
    hour = x.strftime("%H:%M%p")
    link = "/static/images/kuwait-1.png"    
    try:
...
def article_qatar(request):
    ...
    now1 = x.strftime("%d-%m-%Y")
    hour = x.strftime("%H:%M%p")
    link = "/static/images/qatar-1.png"
    try:
        list,list1,title = ScrpeData_goldpricestoday("https://united-arab-emirates.gold-price-today.com/")
        i = 0
        for lis in list:
...
def article_jordan(request):
    ...
    now1 = x.strftime("%d-%m-%Y")
    hour = x.strftime("%H:%M%p")
    link = "/static/images/Jordan-1.png"
    try:
        list,list1,title = ScrpeData_goldpricestoday("https://united-arab-emirates.gold-price-today.com/")
        i = 0
        for lis in list:
...
def article_bahrain(request):
    ...
    now1 = x.strftime("%d-%m-%Y")
    hour = x.strftime("%H:%M%p")
    link = "/static/images/bahrain-1.png"
    try:
...
def article_palestine(request):
    ...
    now1 = x.strftime("%d-%m-%Y")
    hour = x.strftime("%H:%M%p")
    link = "/static/images/Palestine-1.png"
    try:
...
def article_lebanaon(request):
    ...
    now1 = x.strftime("%d-%m-%Y")
    hour = x.strftime("%H:%M%p")
    link = "/static/images/Lebanon-1.png"
    try:
...
def article_algeria(request):
    ...
    now1 = x.strftime("%d-%m-%Y")
    hour = x.strftime("%H:%M%p")
    link = "/static/images/algeria-1.png"
    try:
...
def article_marocco(request):
    ...
    now1 = x.strftime("%d-%m-%Y")
    hour = x.strftime("%H:%M%p")
    link = "/static/images/morocco-1.png"
    try:
...
def DollarPricetoday(request):
    try:
        list,list1,date,span1,span2 = ScrapDollarPricetoday("https://eldolar.live")
        context = {
